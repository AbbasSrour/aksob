...
export type UseSortOptions<TMulti extends boolean = false> =
	UseSortOptionsBase &
...
export function useSort<TMulti extends boolean = false>(
	...
	const { searchParam = "sort", multi = false } = (options ??
		{}) as UseSortOptionsBase;
