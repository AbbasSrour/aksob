...
import { Calendar } from "@aksob/ui/core/calendar";
import {
	Popover,
	PopoverContent,
	PopoverTrigger,
...
export function DatePicker({
	...
	const [selectedPresetValue, setSelectedPresetValue] = React.useState<
		string | undefined
	>(undefined);
	...
	return (
		<Popover>
			...
			<PopoverContent
				className={cn("w-auto", showPresets ? "p-2 space-y-2" : "p-0")}
				align="start"
			>
