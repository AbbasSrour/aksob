...
import { Drawer, DrawerContent, DrawerTrigger } from "@aksob/ui/core/drawer";
import {
	Popover,
	PopoverContent,
	PopoverTrigger,
...
import { useIsMobile } from "@aksob/ui/hooks/is-mobile";
...
interface OptionsListProps
	extends Omit<ComponentPropsWithoutRef<typeof Command>, "onChange"> {
	options: ComboboxOption[];
	value: string;
	onChange: (value: string) => void;
...
function OptionsList({
	...
	const intersection = useIntersection(
		observerRef as RefObject<HTMLDivElement>,
		{
			root: null,
			rootMargin: "0px",
			threshold: 1,
