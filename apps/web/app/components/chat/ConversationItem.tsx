		...
		>
			...
			<div className="flex-1 min-w-0">
				<div className="flex justify-between items-center mb-0.5">
					...
					<span className={`text-xs flex-shrink-0 ml-2 ${isActive ? "text-white/70" : "text-gray-400"}`}>
						{time}
					</span>
				</div>

				<div className="flex justify-between items-center">
					<p className={`text-xs truncate pr-2 ${isActive ? "text-white/80" : unreadCount > 0 ? "text-gray-700 font-medium" : "text-gray-500"}`}>
						{lastMessage}
					</p>
