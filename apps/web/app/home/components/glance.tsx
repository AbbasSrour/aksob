...
export function Glance() {
	...
	// Initial reveal class for stats cards
	const statsRevealClass = isVisible
		? "opacity-100 translate-y-0"
	...
	return (
		<section
			ref={sectionRef}
			className="relative z-10 pt-24 md:pt-32 pb-24 md:pb-32"
		>
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mt-16 md:mt-24">
					<div className="flex">
						...
						<div className="flex-1 md:pl-1">
							<div
								className={`transition-all duration-500 ${statsRevealClass}`}
								style={
									isVisible
										? {
