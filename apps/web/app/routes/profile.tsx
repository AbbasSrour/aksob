import { Briefcase, Edit2, GraduationCap, Mail, MapPin, Phone, Save } from "lucide-react";
					...
					<div className="space-y-4">
						...
						<div className="flex gap-3">
							...
							<div className="min-w-0 flex-1">
								<h4 className="text-sm font-medium text-gray-900">{user.position}</h4>
								<p className="text-xs text-[var(--aksob-primary)]">{user.company}</p>
								<p className="text-xs text-gray-400 mt-0.5">Jan 2020 - Present</p>
							</div>
						</div>
						...
						<div className="flex gap-3">
							...
							<div className="min-w-0 flex-1">
								<h4 className="text-sm font-medium text-gray-900">Junior Developer</h4>
								<p className="text-xs text-gray-500">WebSolutions Inc.</p>
								<p className="text-xs text-gray-400 mt-0.5">Jun 2018 - Dec 2019</p>
							</div>
						</div>
					</div>
				</Card>
