...
export default function VerifyEmailSent() {
	...
	return (
		<div className="w-full text-center py-4 animate-fade-in">
			...
			<h2 className="text-2xl font-bold text-[var(--aksob-darkest)] mb-2">Check Your Email</h2>
			...
			<div className="space-y-6">
				<Button variant="primary" fullWidth size="lg" onClick={() => window.open("mailto:")}>
					Open Email App
				</Button>

				<div className="text-sm">
					<p className="text-[var(--gray-600)] mb-2">Didn't receive the email?</p>
					<div className="flex flex-col gap-1">
						<span className="text-[var(--gray-500)] text-xs">Check spam folder or</span>
						<button
							type="button"
