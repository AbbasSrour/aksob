...
export default function VerifyEmail() {
	...
	if (status === "loading") {
		return (
			<div className="w-full text-center py-8 animate-fade-in">
				...
				<h2 className="text-xl font-bold text-[var(--aksob-darkest)]">Verifying your email...</h2>
			</div>
		);
	}
	...
	if (status === "success") {
		return (
			<div className="w-full text-center py-4 animate-slide-up">
				...
				<h2 className="text-2xl font-bold text-[var(--aksob-darkest)] mb-2">Email Verified!</h2>
	...
	return (
		<div className="w-full text-center py-4 animate-slide-up">
			...
			<h2 className="text-2xl font-bold text-[var(--aksob-darkest)] mb-2">Verification Failed</h2>
			<p className="text-[var(--gray-600)] mb-8">
