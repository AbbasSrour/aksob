...
import { ChatHeader, MessageBubble, MessageInput, type MessageProps } from "~/components/chat";
...
const MOCK_USERS: Record<string, { name: string; isOnline: boolean; status: string }> = {
				...
				{messages.length === 0 ? (
					...
					<>
						<div className="flex items-center justify-center my-4">
							...
							<span className="mx-2 text-xs text-gray-500 font-medium">Today</span>
							<div className="bg-gray-200 h-[1px] flex-1 max-w-[100px]"></div>
						</div>
						{messages.map((msg, i) => {
