...
export function DonorFormSkeleton() {
	return (
		<Main>
			<PageHeader
				title="Donor"
				description="Add or edit a donor on the Wall of Giving."
				withSeparator
			/>
			...
			<FormContent>
				<FormSection layout="vertical">
					<FormSectionHeader>
						<FormSectionTitle>Donor Details</FormSectionTitle>
						<FormSectionDescription>
							Enter the donor's name, position, company, and contribution.
						</FormSectionDescription>
					</FormSectionHeader>
