...
export const storyCategoryOptions = [
	{ label: m.stories_category_career_advancement(), value: "career_advancement" },
	{ label: m.stories_category_entrepreneurship(), value: "entrepreneurship" },
	{ label: m.stories_category_industry_recognition(), value: "industry_recognition" },
	{ label: m.stories_category_social_impact(), value: "social_impact" },
	{ label: m.stories_category_academic_achievement(), value: "academic_achievement" },
