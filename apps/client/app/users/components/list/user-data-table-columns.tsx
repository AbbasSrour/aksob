...
export const userDataTableColumns = [
  ...
  columnHelper.accessor('name', {
    id: 'name',
    header: ({ column }) => (
      <DataTableColumnHeader title={m.users_table_column_user()} column={column} />
    ),
    cell: ({ cell }) => (
  ...
  columnHelper.accessor('phoneNumber', {
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={m.users_table_column_phone()} />
    ),
    cell: ({ cell }) => (
      <DataTablePhoneCell value={cell.getValue()} />
    ),
    enableSorting: true,
    enableHiding: false,
  }),
  ...
  columnHelper.accessor('role', {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={m.users_table_column_role()} />
    ),
    cell: ({ row }) => {
			return (
  ...
  columnHelper.accessor(userStatusFilter.getValue, {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={m.users_table_column_status()} />
    ),
    cell: ({ cell }) => (
      <DataTableBadgeCell 
				value={cell.getValue()} 
