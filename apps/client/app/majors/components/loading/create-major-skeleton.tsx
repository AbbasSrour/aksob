...
export function CreateMajorSkeleton() {
	return (
		<Main>
			<PageHeader
				title="New Major"
				description="Add a new academic major to the system."
				withSeparator
			/>
			...
			<FormContent>
				<FormSection layout="vertical">
					<FormSectionHeader>
						<FormSectionTitle>Major Details</FormSectionTitle>
						<FormSectionDescription>
							Enter the major's name, description, credits, and duration.
						</FormSectionDescription>
					</FormSectionHeader>
